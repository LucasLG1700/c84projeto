...
function my_keydown(e)
{
	...
	console.log(keyPressed);
		...
		{
			aplhabetkey();
		document.getElementById("d1").innerHTML="Tecla Alfabeto";
		console.log("alphabeto key");
		}
		else if(keyPressed >=48 && keyPressed<=57){
			numberkey();
			document.getElementById("d1").innerHTML="Tecla Numeral";
		}
		else if(keyPressed >=37 && keyPressed<=40){
			arrowkey();
			document.getElementById("d1").innerHTML="Tecla Direcional";
		}
		else if(keyPressed ==17 || keyPressed ==18 ||keyPressed ==27){
			specialkey();
			document.getElementById("d1").innerHTML="Tecla Especiais";
		}
	else{
		otherkey();
